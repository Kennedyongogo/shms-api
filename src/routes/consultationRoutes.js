...
const {
  requireAppointmentDoctorOrAdminFromBody,
  requireAppointmentDoctorOrAdminParam,
  requireConsultationDoctorOrAdmin,
} = require("../middleware/doctorAccess");

const router = express.Router();

// Assigned doctor or Super Admin can record and manage consultations.
